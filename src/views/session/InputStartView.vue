...
import ValidatedForm from '@/components/form/validated-form.vue'
...
const onSubmit = async (): Promise<void> => {
  const successful = await new PutStartApi(form).put()
  if (successful) {
...
<template>
  ...
  <ValidatedForm :onSubmit="onSubmit" v-slot="{ submitting }">
    <BFormRadioGroup
